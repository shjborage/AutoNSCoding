...
- (void)test
{
  ...
  NSLog(@"%@", [[TMDiskCache sharedCache] objectForKey:@"kFullCopy"]);
  ...
  NSLog(@"%@", [[TMDiskCache sharedCache] objectForKey:@"kChildren"]);
}

#pragma mark - App LifeStyle
