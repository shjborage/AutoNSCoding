#
#  Be sure to run `pod spec lint AutoNSCoding.podspec.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors          = { "Eric" => "shjborage@icloud.com", "other author" => "email@address.com" }
  # s.author           = 'Eric', 'other author'
  ...
  s.source       = { :git => "https://github.com/shjborage/AutoNSCoding.git", :tag => "0.1.1" }
